...
CREATE OR REPLACE FUNCTION "public"."process_scheduled_deletions"() RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    rec RECORD;
...
BEGIN
    ...
    LOOP
        ...
        -- Delete the user from auth.users (cascades automatically to public.profiles)
...
ALTER FUNCTION "public"."process_scheduled_deletions"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."schedule_account_deletion"("reason" "text" DEFAULT 'Потребителят пожела изтриване на акаунта'::"text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."schedule_account_deletion"("reason" "text") OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."process_scheduled_deletions"() TO "anon";
GRANT ALL ON FUNCTION "public"."process_scheduled_deletions"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_scheduled_deletions"() TO "service_role";



GRANT ALL ON FUNCTION "public"."schedule_account_deletion"("reason" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."schedule_account_deletion"("reason" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."schedule_account_deletion"("reason" "text") TO "service_role";
