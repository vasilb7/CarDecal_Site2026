    ...
    >
      ...
      >
        <div className="flex flex-col items-start border-b pb-6 dark:border-zinc-700 border-zinc-200 w-full">
          <span className="mb-6 inline-block dark:text-zinc-50 text-zinc-900 font-medium">
            {tier}
          </span>
          <span className="mb-3 inline-block text-4xl font-medium">
            {price}
          </span>
          <span className="dark:bg-gradient-to-br dark:from-zinc-200 dark:to-zinc-500 bg-gradient-to-br from-zinc-700 to-zinc-900 bg-clip-text text-transparent min-h-[3rem] flex items-center">
            {bestFor}
          </span>
        </div>
