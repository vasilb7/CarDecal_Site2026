...
const FeaturedProductCard: React.FC<FeaturedProductCardProps> = ({ product, isPriority = false }) => {
  ...
  const CardContent = (
    <motion.div
      ...
      className="bg-gradient-to-b from-[#141414] to-[#0A0A0A] rounded-[24px] md:rounded-[32px] p-5 md:p-8 flex flex-col h-full justify-between relative shadow-2xl border border-white/5 transition-colors overflow-hidden group/card"
    >
      {/* Product Image Area */}
