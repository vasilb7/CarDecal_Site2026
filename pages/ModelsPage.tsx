...
const ModelsPage: React.FC = () => {
    ...
    const categories = useMemo(() => [
        { 
            id: 'top', 
            icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-8 h-8 md:w-12 md:h-12">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                </svg>
            ), 
            img: '/Site_Pics/Top_models/Pamela Nelson/modelpage/1.jpeg',
        ...
        { 
            ...
            img: '/Site_Pics/New_Faces/Loren Torrente/Page/1.jpeg',
        ...
        { 
            ...
            img: '/Site_Pics/Trending/Victoria James/Page/1.jpeg',
            shadow: 'group-hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]'
        },
        { 
            id: 'visiting', 
        ...
        { 
            ...
            img: '/Site_Pics/Model_pics_together/1.jpeg',
            shadow: 'group-hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]'
        }
    ], []);
    ...
    const filteredModels = useMemo(() => {
        return allModels.filter(model => {
            ...
            if (urlCategory === 'new') quickMatch = model.categories.includes('New Faces') || model.slug === 'alexandra-white';
            if (urlCategory === 'trending') quickMatch = model.categories.includes('Trending');
            if (urlCategory === 'visiting') quickMatch = model.categories.includes('Visiting') || model.slug === 'paula-young';
            ...
            return searchMatch && categoryMatch && locationMatch && hairMatch && eyeMatch && quickMatch;
        });
                                ...
                                <div className="relative z-10 flex flex-col items-center p-8 text-center">
                                    ...
                                    <div className="mt-10 opacity-0 group-hover:opacity-100 transition-all duration-1000 transform translate-y-10 group-hover:translate-y-0">
                                        <div className="flex flex-col items-center gap-4">
                                            ...
                                            <span className="text-[10px] md:text-xs text-white uppercase tracking-[0.4em] font-black">{t('models.enter_catalog')}</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="container mx-auto px-4 mt-[-40px] relative z-10">
                        ...
                        {filteredModels.length > 0 ? (
                            ...
                            <div className="text-center py-32 bg-surface/30 border border-dashed border-white/5">
                                <p className="text-text-muted uppercase tracking-[0.2em] text-sm">{t('models.no_matches')}</p>
                            </div>
                        )}
                    </div>
                </>
